...
class Visual(object):
    ...
    def plot_bar_from_df(cls,df,col,title_name,max_vals=15):
        ...
        fig = plt.gcf()
        fig.savefig('output_{}.png'.format(title_name))
    @classmethod
    def plot_relation_distribution(cls,df):
        ...
        plt.ylabel('Количество пользователей')
        fig = plt.gcf()
        fig.savefig('output_relation.png')
    @classmethod
    def plot_political_distribution(cls,df):
        ...
        plt.ylabel('Количество пользователей')
        fig = plt.gcf()
        fig.savefig('output_political.png')
    @classmethod
    def plot_occupation_distribution(cls,df):
        ...
        plt.ylabel('Количество пользователей')
        fig = plt.gcf()
        fig.savefig('output_occupation.png')
    @classmethod
    def plot_smoke_distribution(cls,df):
        ...
        plt.ylabel('Количество пользователей')
        fig = plt.gcf()
        fig.savefig('output_smoking.png')
    @classmethod
    def plot_people_main(cls,df):
        ...
        plt.ylabel('Количество пользователей')
        fig = plt.gcf()
        fig.savefig('output_people_main.png')
    @classmethod
    def plot_alco_distribution(cls,df):
        ...
        plt.ylabel('Количество пользователей')
        fig = plt.gcf()
        fig.savefig('output_alcohol.png')
